...
export default function Contact() {
  ...
  const submit = useSubmit(); // used for manual submission in case some logic needs to be performed like "validations"
  ...
  const handleSubmit = (event) => {
    ...
    // go ahead to submit the form when the user consent
    if (userConfirmed) {
